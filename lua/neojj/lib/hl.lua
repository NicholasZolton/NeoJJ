...
function M.setup(config)
  ...
  hl_store = {
    ...
    NeoJJUnmergedInto             = { fg = palette.bg_purple, bold = palette.bold, ctermfg = 5 },
    NeoJJUnpushedTo               = { fg = palette.bg_purple, bold = palette.bold, ctermfg = 5 },
    NeoJJUnpulledFrom             = { fg = palette.bg_purple, bold = palette.bold, ctermfg = 5 },
    NeoJJStatusHEAD               = {},
    NeoJJObjectId                 = { link = "NeoJJSubtleText" },
    NeoJJStash                    = { link = "NeoJJSubtleText" },
    NeoJJRebaseDone               = { link = "NeoJJSubtleText" },
    NeoJJFold                     = { fg = "None", bg = "None" },
    NeoJJFoldColumn               = { fg = "None", bg = "None" },
    NeoJJWinSeparator             = { link = "WinSeparator" },
    NeoJJChangeMuntracked         = { link = "NeoJJChangeModified" },
    NeoJJChangeAuntracked         = { link = "NeoJJChangeAdded" },
    NeoJJChangeNuntracked         = { link = "NeoJJChangeNewFile" },
    NeoJJChangeDuntracked         = { link = "NeoJJChangeDeleted" },
    NeoJJChangeCuntracked         = { link = "NeoJJChangeCopied" },
    NeoJJChangeUuntracked         = { link = "NeoJJChangeUpdated" },
    NeoJJChangeRuntracked         = { link = "NeoJJChangeRenamed" },
    NeoJJChangeDDuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUUuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAAuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeDUuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUDuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAUuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUAuntracked        = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUntrackeduntracked = { fg = "None" },
    NeoJJChangeMunstaged          = { link = "NeoJJChangeModified" },
    NeoJJChangeAunstaged          = { link = "NeoJJChangeAdded" },
    NeoJJChangeNunstaged          = { link = "NeoJJChangeNewFile" },
    NeoJJChangeDunstaged          = { link = "NeoJJChangeDeleted" },
    NeoJJChangeCunstaged          = { link = "NeoJJChangeCopied" },
    NeoJJChangeUunstaged          = { link = "NeoJJChangeUpdated" },
    NeoJJChangeRunstaged          = { link = "NeoJJChangeRenamed" },
    NeoJJChangeTunstaged          = { link = "NeoJJChangeUpdated" },
    NeoJJChangeDDunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUUunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAAunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeDUunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUDunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAUunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUAunstaged         = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUntrackedunstaged  = { fg = "None" },
    NeoJJChangeMstaged            = { link = "NeoJJChangeModified" },
    NeoJJChangeAstaged            = { link = "NeoJJChangeAdded" },
    NeoJJChangeNstaged            = { link = "NeoJJChangeNewFile" },
    NeoJJChangeDstaged            = { link = "NeoJJChangeDeleted" },
    NeoJJChangeCstaged            = { link = "NeoJJChangeCopied" },
    NeoJJChangeUstaged            = { link = "NeoJJChangeUpdated" },
    NeoJJChangeRstaged            = { link = "NeoJJChangeRenamed" },
    NeoJJChangeTstaged            = { link = "NeoJJChangeUpdated" },
    NeoJJChangeDDstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUUstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAAstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeDUstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUDstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeAUstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUAstaged           = { link = "NeoJJChangeUnmerged" },
    NeoJJChangeUntrackedstaged    = { fg = "None" },
    ...
    NeoJJUntrackedfiles           = { link = "NeoJJSectionHeader" },
    NeoJJUnstagedchanges          = { link = "NeoJJSectionHeader" },
    NeoJJUnmergedchanges          = { link = "NeoJJSectionHeader" },
    NeoJJUnpulledchanges          = { link = "NeoJJSectionHeader" },
    NeoJJUnpushedchanges          = { link = "NeoJJSectionHeader" },
    NeoJJRecentcommits            = { link = "NeoJJSectionHeader" },
    NeoJJStagedchanges            = { link = "NeoJJSectionHeader" },
    NeoJJStashes                  = { link = "NeoJJSectionHeader" },
    NeoJJMerging                  = { link = "NeoJJSectionHeader" },
    NeoJJBisecting                = { link = "NeoJJSectionHeader" },
    NeoJJRebasing                 = { link = "NeoJJSectionHeader" },
    NeoJJPicking                  = { link = "NeoJJSectionHeader" },
    NeoJJReverting                = { link = "NeoJJSectionHeader" },
